...
var YamlEditor = function (_a) {
    ...
    var _b = react_1.useState(defaultContent), content = _b[0], setContent = _b[1];
    var theme = (defaultTheme || "bright") == "bright" ? "xcode" : "monokai";
    var editorClassnames = classnames_1.default(className, "yaml-editor", theme);
    ...
    return (<div className={editorClassnames}>
            <react_ace_1.default className="ace-code-editor" value={content} theme={theme} mode="yaml" tabSize={tabSize} onChange={handleOnChange} onBlur={handleOnBlur}/>
        </div>);
};
