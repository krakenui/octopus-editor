...
var CKEditorContainer = function (_React$Component) {
  _inherits(CKEditorContainer, _React$Component);

  function CKEditorContainer(props) {
    _classCallCheck(this, CKEditorContainer);

    //Bindings
    var _this = _possibleConstructorReturn(this, (CKEditorContainer.__proto__ || Object.getPrototypeOf(CKEditorContainer)).call(this, props));
  ...
  _createClass(CKEditorContainer, [{
...
var CKEditor = function CKEditor(_ref) {
  ...
  return _react2.default.createElement(CKEditorContainer, {
